...
if __name__ == '__main__':
    ...
    filename_path = 'data/Divide_3k_train.txt'
    save_folder = 'Divide_3k_image'

    #extract_frame(videos_dir, 'B166.mp4', save_folder)
    train_infos, val_infos = train_test_split(filename_path,1)
    ...
    print("val start:")
    videos_dir = '../DataSet/DIVIDE_3k/videos'
    filename_path = 'data/Divide_3k_test.txt'
    save_folder = 'Divide_3k_image'
